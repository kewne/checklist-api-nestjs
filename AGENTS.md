...
For clarity on domain-specific terms, refer to the [glossary](docs/glossary) which documents key concepts used in the codebase and user stories. Use terminology consistent with the glossary when writing code, comments, and documentation.
